...
```{r}
depression <- glm(content_data$mental_illness_diagnosed___1 ~ content_data$regional_resources + content_data$affirmations + content_data$age + content_data$gender, family =binomial)
```
